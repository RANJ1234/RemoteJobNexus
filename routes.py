...
def index():
    ...
    homepage_content = content_store.get_section('homepage')
    carousel_items = content_store.get_section('carousel')
...
# Note: We already have admin_required decorator defined above, so we're removing this duplicate
